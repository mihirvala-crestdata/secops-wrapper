...
def setup_feed_command(subparsers):
    ...
    create_parser.add_argument("--display-name", required=True, help="Feed display name")
    create_parser.add_argument("--details", required=True, help="Feed details as JSON string")
    ...
    update_parser.add_argument("--display-name", required=False, help="Feed display name")
    update_parser.add_argument("--details", required=False, help="Feed details as JSON string")
    ...
    disable_parser = feed_subparsers.add_parser("disable", help="Disable a feed")
    ...
    generate_secret_parser = feed_subparsers.add_parser("generate-secret", help="Generate a secret for a feed")
    generate_secret_parser.add_argument("--id", required=True, help="Feed ID")
    generate_secret_parser.set_defaults(func=handle_feed_generate_secret_command)
